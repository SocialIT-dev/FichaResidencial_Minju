...
{
    public partial class FichaResidencialHistorial : System.Web.UI.Page
    {
        ...
        */
        ...
        #region Estadísticas de tiempos de proceso
        [WebMethod]
        ...
        [WebMethod]
        public static List<GETTiemposXProyectoDto> ObtenerListadoFichasXProyecto(int CodProyecto)
        {
            List<GETTiemposXProyectoDto> result;
            GETTiemposXProyectoImpl _getTiemposXProyectoImpl = new GETTiemposXProyectoImpl();
            result = _getTiemposXProyectoImpl.ObtenerTiemposXProyecto(CodProyecto);
            
            return result;
        }
        [WebMethod]
        public static List<GETTiemposXEtapaDto> ObtenerListadoResidenciasXTiempoPromedioGeneral(string CodEtapa)
        {
            List<GETTiemposXEtapaDto> result;
            GETTiemposXEtapaImpl _gETTiemposXEtapaImpl = new GETTiemposXEtapaImpl();
            result = _gETTiemposXEtapaImpl.ObtenerTiemposXEtapa(CodEtapa);

            return result;
        }
        #endregion

        #region Estadísticas de evolución de indicadores cuantitativos
        [WebMethod]
        public static List<GETCantidadesGeneralesDto> ObtenerDatosEstadisticosPorTipoAntecedentesGenerales(int codinstitucion, int codproyecto, int paramtipoEvolucion, int yearRegistro)
        { 
            List<GETCantidadesGeneralesDto> result;
            GETCantidadesGeneralesImpl _getCantidadesGeneralesImpl = new GETCantidadesGeneralesImpl();
            result = _getCantidadesGeneralesImpl.ObtenerCantidadesGenerales(codinstitucion, codproyecto, paramtipoEvolucion, yearRegistro);

            return result;
        }
        [WebMethod]
        public static List<GETCantidadesPersonalDto> ObtenerDatosEstadisticosPorTipoAntecedentesPersonal(int codinstitucion, int codproyecto, int paramtipoEvolucion, int yearRegistro)
        {
            List<GETCantidadesPersonalDto> result;
            GETCantidadesPersonalImpl _getCantidadesPersonalImpl = new GETCantidadesPersonalImpl();
            result = _getCantidadesPersonalImpl.ObtenerCantidadesPersonal(codinstitucion, codproyecto, paramtipoEvolucion, yearRegistro);

            return result;
        }
        [WebMethod]
        public static List<GETCantidadesInfraestructuraDto> ObtenerDatosEstadisticosPorTipoAntecedentesInfraestructura(int codinstitucion, int codproyecto, int yearRegistro)
        {
            List<GETCantidadesInfraestructuraDto> result;
            GETCantidadesInfraestructuraImpl _getCantidadesInfraestructuraImpl = new GETCantidadesInfraestructuraImpl();
            result = _getCantidadesInfraestructuraImpl.ObtenerCantidadesInfraestructura(codinstitucion, codproyecto, yearRegistro);

            return result;
        }
        [WebMethod]
        public static List<GETCantidadesSaludDto> ObtenerDatosEstadisticosPorTipoAntecedentesSalud(int codinstitucion, int codproyecto, int yearRegistro)
        {
            List<GETCantidadesSaludDto> result;
            GETCantidadesSaludImpl _getCantidadesSaludImpl = new GETCantidadesSaludImpl();
            result = _getCantidadesSaludImpl.ObtenerCantidadesSalud(codinstitucion, codproyecto, yearRegistro);

            return result;
        }        
        [WebMethod]
        public static List<GETCantidadesEducacionDto> ObtenerDatosEstadisticosPorTipoAntecedentesEducacion(int codinstitucion, int codproyecto, int yearRegistro)
        {
            List<GETCantidadesEducacionDto> result;
            GETCantidadesEducacionImpl _getCantidadesEducacionImpl = new GETCantidadesEducacionImpl();
            result = _getCantidadesEducacionImpl.ObtenerCantidadesEducacion (codinstitucion, codproyecto, yearRegistro);

            return result;
        }        
        [WebMethod]
        public static List<GETCantidadesAlimentacionDto> ObtenerDatosEstadisticosPorTipoAntecedentesAlimentacion(int codinstitucion, int codproyecto, int yearRegistro)
        {
            List<GETCantidadesAlimentacionDto> result;
            GETCantidadesAlimentacionImpl _getCantidadesAlimentacionImpl = new GETCantidadesAlimentacionImpl();
            result = _getCantidadesAlimentacionImpl.ObtenerCantidadesAlimentacion (codinstitucion, codproyecto, yearRegistro);

            return result;
        }
        [WebMethod]
        public static List<GETProyectosConFichaDto> ObtenerProyectosConFicha(int codinstitucion, int codproyecto, int yearRegistro)
        { 
            List<GETProyectosConFichaDto> result;
            GETProyectosConFichaImpl _getCantidadesAlimentacionImpl = new GETProyectosConFichaImpl();
            result = _getCantidadesAlimentacionImpl.ObtenerProyectosConFicha (codinstitucion, codproyecto, yearRegistro);

            return result;
        }
        #endregion

        #region Buscar listado de ficha ingresadas
        [WebMethod]
        public static List<ListaFichasIngresadasDto> BuscarFichasResidenciales(int CodProyecto, int CantidadPag, int IdUsuarioSenainfo, int CodInstitucion, int numpagina)
        {

            ListaFichasIngresadasImpl _listaFichasIngresadasImpl = new ListaFichasIngresadasImpl();
            var result = _listaFichasIngresadasImpl.ObtenerListaFichasIngresadas(CodProyecto, CantidadPag, IdUsuarioSenainfo, CodInstitucion, numpagina);
            return result;
        }

        [WebMethod]
        public static List<ListaFichasIngresadasTotalDto> BuscarFichasResidencialesTotal(int CodProyecto, int IdUsuarioSenainfo, int CodInstitucion)
        {
            ListaFichasIngresadasImpl _listaFichasIngresadasImpl = new ListaFichasIngresadasImpl();
            var result = _listaFichasIngresadasImpl.ObtenerListaFichasIngresadasTotal(CodProyecto, IdUsuarioSenainfo, CodInstitucion);
            return result;
        }
        #endregion
    }
