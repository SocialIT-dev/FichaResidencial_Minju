<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FichaResidencialObservaciones.aspx.cs" Inherits="SENAME.Senainfo.ModFichaResidencial.WEB.ModFichaResidencial.FichaResidencialObservaciones" %>
...
<div class="container">
    ...
    <h3 class="titsec" onclick="InicializaKey();">FICHA RESIDENCIAL - GESTI&Oacute;N OBSERVACIONES</h3>
    <!--<button onclick=" MensajeProcesandoVisadosAutomatico();">clic</button>-->
    <div id="divListadoFichasXResponder" class="well">
        ...
        <div id="collapse_Form" role="tabpanel" aria-labelledby="headingOne" class="panel-collapse collapse in">
            <div class="row">
                <div class="col-md-9">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    -->
                                    <button id="Button1" class="btn btn-warning" style="cursor: pointer;font-weight:normal;" title="Clic para grabar respuesta y finalizar la tramitación de las a observaciones PJUD a ficha residencial" onclick="BuscarFichasResidencialesOBS(1, 'BSQGRAL');"><span class="glyphicon glyphicon-zoom-in"></span>&nbsp;Buscar</button>
                                    <!--
    ...
    <div class="well" id="div_respuestas_General_OBS">
        ...
        <div id="DivFichaResp010" role="tabpanel" aria-labelledby="headingOne" class="panel-collapse collapse" aria-expanded="false">
            ...
            <div id="div6" style="width:100%;">
                ...
                <button id="btnResponderOBS_General2" class="btn btn-warning" style="cursor: pointer;font-weight:normal;margin-top:10px;" title="Clic para grabar inicio de la tramitación de las a observaciones PJUD a ficha residencial" onclick="GrabarRespuestaGeneralSENAME2();"><span class="glyphicon glyphicon-comment"></span>&nbsp;Iniciar Tramitación de Observaciones PJUD</button>
            </div>
         </div>
    </div>
...
<div id="divconfig" style="display:none;" onclick="InicializaKey();"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            importarScript("../Scripts/ficha/residencia1observaciones.js?" + d.getTime());
